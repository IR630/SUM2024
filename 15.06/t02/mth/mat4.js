class _mat4 {
  ...
  view(loc, at, up1) {
    ...
    dir = this.normalize(this.sub(at, loc));
    right = this.normalize(this.cross(dir, up1));
    up = this.normalize(this.cross(right, dir));
    m = [
      [
        [right.x, up.x, -dir.x, 0],
        [right.y, up.y, -dir.y, 0],
        [right.z, up.z, -dir.z, 0],
        [-this.dot(loc, right), -this.dot(loc, up), this.dot(loc, dir), 1],
      ],
    ];
